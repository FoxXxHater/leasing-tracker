...
class LeasingTrackerSensor(SensorEntity):
    ...
    def _setup_sensor_attributes(self) -> None:
        ...
        sensor_configs = {
            SENSOR_REMAINING_KM_TOTAL: {
                "translation_key": "remaining_distance_total",
                "icon": "mdi:counter",
                "unit": distance_unit,
            ...
            SENSOR_REMAINING_KM_YEAR_ACTUAL: {
                "translation_key": "remaining_distance_year_actual",
            ...
            SENSOR_REMAINING_KM_MONTH_ACTUAL: {
                "translation_key": "remaining_distance_month_actual",
                "icon": "mdi:calendar-today",
                "unit": distance_unit,
                "device_class": SensorDeviceClass.DISTANCE,
                "state_class": SensorStateClass.MEASUREMENT,
            ...
            SENSOR_ESTIMATED_KM_YEAR_END: {
                "translation_key": "estimated_distance_year_end",
            ...
            SENSOR_ESTIMATED_KM_MONTH_END: {
                "translation_key": "estimated_distance_month_end",
                "icon": "mdi:chart-timeline-variant",
                "unit": distance_unit,
                "device_class": SensorDeviceClass.DISTANCE,
                "state_class": SensorStateClass.MEASUREMENT,
            ...
            SENSOR_KM_DRIVEN_THIS_MONTH: {
                "translation_key": "distance_driven_this_month",
                "icon": "mdi:calendar-month",
                "unit": distance_unit,
                "device_class": SensorDeviceClass.DISTANCE,
                "state_class": SensorStateClass.MEASUREMENT,
            ...
            SENSOR_KM_DRIVEN_THIS_YEAR: {
                "translation_key": "distance_driven_this_year",
                "icon": "mdi:calendar",
                "unit": distance_unit,
                "device_class": SensorDeviceClass.DISTANCE,
                "state_class": SensorStateClass.MEASUREMENT,
            ...
            SENSOR_ALLOWED_KM_TOTAL: {
                "translation_key": "allowed_distance_total",
            ...
            SENSOR_ALLOWED_KM_PER_MONTH: {
                "translation_key": "allowed_distance_per_month",
                "icon": "mdi:calendar-month",
                "unit": distance_unit,
                "device_class": SensorDeviceClass.DISTANCE,
                "state_class": SensorStateClass.MEASUREMENT,
            ...
            SENSOR_ALLOWED_KM_THIS_YEAR: {
                "translation_key": "allowed_distance_this_year",
                "icon": "mdi:calendar",
                "unit": distance_unit,
                "device_class": SensorDeviceClass.DISTANCE,
                "state_class": SensorStateClass.MEASUREMENT,
            ...
            SENSOR_ALLOWED_KM_THIS_MONTH: {
                "translation_key": "allowed_distance_this_month",
                "icon": "mdi:calendar-month",
                "unit": distance_unit,
                "device_class": SensorDeviceClass.DISTANCE,
                "state_class": SensorStateClass.MEASUREMENT,
            ...
            SENSOR_KM_DIFFERENCE: {
                "translation_key": "distance_difference",
                "icon": "mdi:delta",
                "unit": distance_unit,
                "device_class": SensorDeviceClass.DISTANCE,
                "state_class": SensorStateClass.MEASUREMENT,
            ...
            SENSOR_ESTIMATED_KM_LEASE_END: {
                "translation_key": "estimated_distance_lease_end",
            ...
            SENSOR_ESTIMATED_EXCESS_KM: {
                "translation_key": "estimated_excess",
            ...
            SENSOR_ESTIMATED_UNDER_KM: {
                "translation_key": "estimated_under",
